        ...
        if (count($users) > 0) {
            ...
            foreach ($users as $user) {
                ...
                if (!$is_sent) {
                    ...
                    $Telegram_API->sendLocation($user->active_chat_id, $balloon->latitude, $balloon->longitude, NULL);
                    $sent = $Telegram_API->sendMessage($user->active_chat_id, $telegram_message, NULL,TRUE); // TODO: thread ID
